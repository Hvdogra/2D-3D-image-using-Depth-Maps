...
1. Run the main file using python: python test.py <input-image>
	Sample run
		python test.py oxford.jpg
			oxford.jpg is there in the same folder.
2. The result will be  coordinates of the vanishing point.
	The ouput image will be shown in the presentation.
